...
class Formula:
	...
	__proposition_rules = {"da=0" : [{"~":"da=0"},{"":"da=5"}, {"":"da=10"},{"":"da=15"},{"":"da=20"}],
                            "da=5" : [{"":"da=0"},{"~":"da=5"}, {"":"da=10"},{"":"da=15"},{"":"da=20"}],
                            "da=10" : [{"":"da=0"},{"":"da=5"}, {"~":"da=10"},{"":"da=15"},{"":"da=20"}],
                            "da=15" : [{"":"da=0"},{"":"da=5"}, {"":"da=10"},{"~":"da=15"},{"":"da=20"}],
                            "da=20" : [{"":"da=0"},{"":"da=5"}, {"":"da=10"},{"":"da=15"},{"~":"da=20"}],
                            "b=0" : [{"~":"b=0"},{"":"b=1"},{"":"b=2"},{"":"b=3"}],
                            "b=1" : [{"":"b=0"},{"~":"b=1"},{"":"b=2"},{"":"b=3"}],
                            "b=2" : [{"":"b=0"},{"":"b=1"},{"~":"b=2"},{"":"b=3"}],
                            "b=3" : [{"":"b=0"},{"":"b=1"},{"":"b=2"},{"~":"b=3"}],
